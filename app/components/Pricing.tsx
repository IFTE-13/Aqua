    ...
    <section id="pricing" className="py-24 bg-white">
      <div className="container mx-auto">
          ...
          <p className="section-description mt-5">
            Discover your perfect water bottle. Elevate your hydration with our thoughtfully designed, sustainable options. Join the refreshment revolution today.
          </p>
        </div>
          ...
          {pricingTiers.map(({ title, monthlyPrice, buttonText, popular, inverse, features}) => ( 
            <div 
              ...
              <div className="flex items-baseline gap-1 mt-[30px]">
                ...
                <span className="tracking-tight font-bold text-black/50">/each</span>
              </div>
